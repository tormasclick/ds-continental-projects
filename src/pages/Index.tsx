...
import { ArrowRight, Truck, Shield, Gem, Factory, Globe, Pickaxe, Wrench, BarChart3, ChevronRight, ChevronLeft, Wheat } from "lucide-react";
  ...
  return (
    <div>
      ...
      <section className="relative h-[85vh] overflow-hidden">
        ...
        {/* Centered Content - Added justify-center and text-center */}
        <div className="absolute inset-0 flex items-center justify-center text-center">
          <div className="container mx-auto px-4">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-headline text-white max-w-4xl mx-auto animate-fade-in-up">
              Powering Industry Across East and Central Africa
            </h1>
            <p className="mt-4 text-lg md:text-xl text-white/80 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
              <Link to="/companies" className="px-7 py-3 bg-industrial-red text-white font-subheading rounded-md hover:opacity-90 transition-opacity flex items-center gap-2">
        ...
        {/* Left and Right Navigation Buttons - NEW */}
        <button 
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-2 z-20">
          {slides.map((_, i) => (
            <button 
              ...
              className={`h-2 rounded-full transition-all ${i === activeSlide ? "bg-white w-6" : "bg-white/40 w-2"}`} 
            />
          ))}
        </div>
      </section>
      <section className="py-20">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <Link to="/about" className="mt-6 inline-flex items-center justify-center text-center gap-2 text-electric-blue font-subheading hover:underline">
